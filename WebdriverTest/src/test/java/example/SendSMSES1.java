...
public class SendSMSES1 extends NewTest {
	@Test
	public void FailSMS() throws IOException, NexmoClientException {
		...
		TextMessage message = new TextMessage(NEXMO_BRAND_NAME, TO_NUMBER,
				"!!P0 Critical Alert ES1 is down!!");

		SmsSubmissionResponse response = client.getSmsClient().submitMessage(message);

		TextMessage message1 = new TextMessage(NEXMO_BRAND_NAME, TO_NUMBER1,
				"!!P0 Critical Alert ES1 is down!!");
		...
		kong.unirest.HttpResponse<String> responsew = Unirest
				.get("https://panel.apiwha.com/send_message.php?apikey=84JHPQ0GROB5B0I83XLK&number=" + TO_NUMBER
						+ "&text=!!ES1+Server+is+down!!")
				.asString();

		kong.unirest.HttpResponse<String> responsew1 = Unirest
				.get("https://panel.apiwha.com/send_message.php?apikey=84JHPQ0GROB5B0I83XLK&number=" + TO_NUMBER1
						+ "&text=!!ES1+Server+is+down!!")
				.asString();
